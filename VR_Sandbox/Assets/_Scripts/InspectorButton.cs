/*
    Purpose:
            Adds a button to the inspector. Simply add the Attribute on top of a bool class variable.
    How to use:
            [InspectorButton("FunctionName")]
            public bool variable;
    References:
            1. https://www.reddit.com/r/Unity3D/comments/1s6czv/inspectorbutton_add_a_custom_button_to_your/
*/
